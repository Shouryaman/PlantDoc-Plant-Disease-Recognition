...
#Main Page
if(app_mode=="Home"):
    st.header("PLANTDOC-PLANT DISEASE RECOGNITION SYSTEM")
    ...
    ### Get Started
    Click on the **Disease Recognition** page in the sidebar to upload an image and experience the power of PlantDoc!
